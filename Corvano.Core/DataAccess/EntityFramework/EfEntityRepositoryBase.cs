    ...
    where TContext : DbContext
{
    ...
    /// <summary>Tek kayıt izlenmeden okunur; varlık kontrolü ve gösterim içindir.</summary>
    ...
    /// <summary>Tek kayıt izlenerek okunur; çağıran onu değiştirip <see cref="Update"/> ya da <see cref="Delete"/> ile kaydedebilir.</summary>
